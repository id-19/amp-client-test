...
const SvgElf = props => {
  const handleMagicActionButtonClick = () => {
    mixpanel.track("Magic Action Performed", {
      "Action": "Magic",
      "Icon": "Elf",
      "Context": "Hypothetical context where the action is performed"
    });
  };
