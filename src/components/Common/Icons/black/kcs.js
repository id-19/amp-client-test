...
import Mixpanel from 'mixpanel'; // Assuming Mixpanel is imported correctly based on project setup

const SvgKcs = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => Mixpanel.track("Icon Interaction", { "Icon Name": "Kcs", "Action": "Click", "Context": "Common Icons" })} >
