...
const SvgDrgn = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon": "Drgn",
      "Action": "Click",
      "Context": "Unknown" // This should be replaced with more specific context information
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <path d="M9.403 9.957l11.024 14.01-8.281-10.514.072 7.327H9.4l.003-10.823zm0-.923l.001-3.947.173.219-.161-.204-.013 3.932zm10.502 9.396l-.072-7.386h2.774l.03 14.18-.038-3.37-2.694-3.424z" opacity={0.398} />
    </svg>
  );
};
