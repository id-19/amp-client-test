...
const SvgKrb = props => {
  const handleIconClick = () => {
    Mixpanel.track("Icon Interaction", {
      "Icon Name": "KRB",
      "Action": "Click",
      "Context": "Black Icon Collection"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} className="icon-krb" // Adding the class name as per the event signature
      onClick={handleIconClick} // Adding the onClick handler for tracking
    >
