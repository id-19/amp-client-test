...
const SvgRic = props => {
  const handleClick = () => {
    Mixpanel.track("Icon Clicked", {
      "Icon Name": "Ric",
      "Context": "Unknown" // This should be replaced with actual context where the component is used
    });
  };
