...
import Mixpanel from 'mixpanel-browser'; // Corrected import for Mixpanel browser integration
...
const SvgNxt = props => (
  <svg 
    ...
    {...props} 
    onClick={() => Mixpanel.track('SVG Icon Clicked', {
      "Icon Name": "Nxt", 
      "Context": "Black Icon Collection", 
      "Path": "src/components/Common/Icons/black/nxt.js"
    })}
  >
