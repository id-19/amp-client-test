...
import { track } from 'mixpanel-browser'; // Assuming mixpanel-browser is the Mixpanel SDK used
    ...
    <button onClick={handleClick} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <g fillRule="evenodd">
          ...
          <path fillRule="nonzero" d="M17.52 20.205L6.257 13.692l10.954-6.307c3.24-1.847 4.166-1.077 6.429.205l-11.263 6.513 5.143 2.974v3.128z" opacity={0.402} />
          <path fillRule="nonzero" d="M12.377 14.103L23.64 7.59v12.615c0 3.744-1.131 4.154-3.394 5.436V12.667L15.05 15.64l-2.674-1.538z" opacity={0.802} />
        </g>
      </svg>
    </button>
  );
