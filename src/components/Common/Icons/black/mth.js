...
const SvgMth = props => {
  ...
  return (
    <button type="submit" aria-label="Submit Form" onClick={trackFormSubmission}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <path d="M15.997 16.458L13.88 20.01c-.439-.11-.911-.536-1.416-1.277L7 9.568c2.025-1.133 4.615-.46 5.784 1.5z" fillOpacity={0.198} />
      </svg>
    </button>
  );
};
