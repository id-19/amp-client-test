...
const SvgLbc = props => {
  const handleSvgClick = () => {
    mixpanel.track("SVG Icon Clicked", {
      "Icon": "LBC",
      "Action": "Clicked",
      "Context": "Unknown" // This should be updated based on the specific use case
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick} // Added onClick event handler to track clicks
    >
