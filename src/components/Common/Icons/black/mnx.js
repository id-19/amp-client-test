...
const SvgMnx = props => {
  ...
  const handleSvgClick = () => {
    ...
    mixpanel.track("Icon Click", {
      "Icon Name": "Mnx",
      "Icon Purpose": "Unknown - Specify based on usage context",
      "Click Context": "Unknown - Specify based on where and how the icon is used"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick} // Add onClick event handler to track the click event
    >
