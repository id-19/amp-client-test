...
const SvgRyo = props => {
  // Function to handle click and view events and track them using Mixpanel
  ...
  // Track view event when the component mounts
  React.useEffect(() => {
    handleEvent("Viewed");
  }, []);

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => handleEvent("Clicked")} // Adding the onClick event handler to track clicks
    >
