...
const SvgGto = props => {
  // Event handler to track the SVG click event
  const handleSvgClick = () => {
    mixpanel.track("GTO Icon Clicked", {
      "Context": "Unknown - Determine based on usage",
      "Action": "Clicked",
      "Success": "True/False - Determine based on outcome"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick} // Adding the onClick event handler
    >
