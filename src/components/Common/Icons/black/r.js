...
const SvgR = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => window.mixpanel.track("Icon Clicked", { "Icon": "Submit", "Context": "Form Submission", "Location": "Common Icons" })}>
