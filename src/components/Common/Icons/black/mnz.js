...
const SvgMnz = props => {
  const trackIconClick = () => {
    mixpanel.track("Icon Click", {
      "Icon Name": "Mnz",
      "Action": "Click",
      "Context": "Assuming wrapped in interactive element for demonstration"
    });
  };

  return (
    <button onClick={trackIconClick} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
