...
const SvgDtr = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => Mixpanel.track("Icon Click", { "Icon": "Dtr", "Action": "Click", "Context": "Unknown - Assume based on implementation" })}>
    <g fillRule="evenodd">
      ...
      <path d="M24.956 17.4c0 1.145-.92 2.074-2.056 2.074s-2.056-.93-2.056-2.075v-5.233c0-1.146.92-2.075 2.056-2.075s2.056.929 2.056 2.075z" fillRule="nonzero" opacity={0.5} />
    </g>
  </svg>
);
