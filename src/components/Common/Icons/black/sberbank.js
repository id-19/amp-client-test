...
const SvgSberbank = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Sberbank Icon Clicked", {"Context": "Sberbank Icon", "Action": "Click"})} style={{ cursor: 'pointer', pointerEvents: 'all' }} >
