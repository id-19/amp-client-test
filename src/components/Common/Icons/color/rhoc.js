...
import mixpanel from 'mixpanel-browser'; // Assuming mixpanel is already initialized elsewhere
...
const SvgRhoc = props => {
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "Rhoc",
      "Action": "Click",
      "Context": "Unknown" // This can be dynamically determined based on props or state if needed
    });
  };
