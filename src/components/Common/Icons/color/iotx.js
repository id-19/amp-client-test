...
const SvgIotx = props => {
  ...
  const handleIconClick = () => {
    mixpanel.track("Icon Click", {
      "Context": "User clicked on the IOTX icon",
      "Width": props.width || 64, // Dynamic based on props.width
      "Height": props.height || 64, // Dynamic based on props.height
      "Color": "#00D4D5"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick} fill="#00D4D5">
      <g fill="none">
