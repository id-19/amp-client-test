...
const SvgVrsc = props => {
  ...
  const handleClick = () => {
    mixpanel.track("Icon Interaction", {
      ...
      "Icon Name": "vrsc",
      "Location in App": "Specify location if relevant"
    });
  };

  // Event handler for hover interaction
