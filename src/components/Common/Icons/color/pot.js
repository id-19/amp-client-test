...
const SvgPot = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Click", {
      "Icon": "Pot",
      "Action": "TBD based on context",
      "Location in App": "TBD based on usage"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick} fill="#105B2F">
