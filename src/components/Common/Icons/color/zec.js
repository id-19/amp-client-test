...
const SvgZec = props => {
  ...
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon Name": "Zec",
      "Action": "Click",
      "Context": "Unknown" // This should be replaced with actual context where the icon is used
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} className="SvgZecIcon" // Added className for tracking
