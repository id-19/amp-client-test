...
const SvgGno = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon Name": "Gno",
      "Action": "Clicked",
      "Context": "Unknown - Consider where and how this icon is used"
    });
  };
