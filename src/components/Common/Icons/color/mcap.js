...
const SomeOtherComponent = () => {
  ...
  const handleViewMoreInfoClick = () => {
    Mixpanel.track("View More Information Clicked", {
      "Icon": "MCap",
      "Section": "Dashboard",
      "User Action": "Click"
    });
  ...
  return (
    <div>
      ...
      <button className="view-more-info-btn" type="button" aria-label="View More Information" onClick={handleViewMoreInfoClick}
