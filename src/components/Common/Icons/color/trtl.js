...
const SvgTrtl = props => {
  const handleIconInteraction = () => {
    mixpanel.track("Icon Interaction", {
      "Action": "Click",
      "Icon Name": "SvgTrtl",
      "Context": "Assumed parent element interaction"
    });
  };
  ...
  return (
    <div onClick={handleIconInteraction} onMouseEnter={handleIconHover}>
