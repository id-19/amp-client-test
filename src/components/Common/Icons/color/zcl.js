...
const SvgZcl = props => {
  useEffect(() => {
    mixpanel.track("Icon Viewed", {
      "Icon Name": "Zcl",
      "Icon Type": "SVG",
      "Path": "src/components/Common/Icons/color/zcl.js"
    });
  }, []);
