...
const SvgLrc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Clicked", {"Icon Type": "Lrc", "Context": "Assumed to be within a clickable element"})}>
