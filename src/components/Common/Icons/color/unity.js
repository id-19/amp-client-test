...
const SvgUnity = props => {
  const trackIconInteraction = () => {
    mixpanel.track('Icon Interaction', {
      'Icon Name': 'Unity',
      'Action': 'Click',
      'Context': "Assuming it's part of a clickable element, context to be determined by its placement in UI"
    });
  };
      ...
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <g fill="none" fillRule="evenodd">
          ...
          <g fill="#fff" fillRule="nonzero">
            ...
            <path d="M25.912 18.875v-5.854c.657.889 1.024 1.882 1.024 2.927 0 1.046-.367 2.037-1.024 2.927zm-1.649-7.46l.005 7.461c-2.343-3.326-5.844-7.511-10.147-8.909a10.616 10.616 0 0 0-2.293-.477A16.87 16.87 0 0 1 15.905 9c3.34 0 6.335.936 8.358 2.415z" opacity={0.5} />
          </g>
        </g>
      </svg>
    </div>
