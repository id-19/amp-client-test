...
const SvgMth = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon Name": "SvgMth",
      "Action": "Clicked",
      "Context": "Assumed to be wrapped in a clickable element"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} fill="#104fca" onClick={handleIconClick} {...props}>
      <g fill="none">
        ...
        <g fill="#fff">
          ...
          <path d="M15.997 16.458L13.88 20.01c-.439-.11-.911-.536-1.416-1.277L7 9.568c2.025-1.133 4.615-.46 5.784 1.5z" fillOpacity={0.8} />
