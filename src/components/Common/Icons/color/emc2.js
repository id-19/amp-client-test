...
const SvgEmc2 = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Click", {"Icon Name": "Emc2", "Action": "TBD - Based on specific use case"})} fill="#0CF" >
    <g fill="none">
      ...
      <g fill="#FFF">
        ...
        <path fillOpacity={0.6} d="M12.277 19.16h4.398l-1.894 3.838h-4.398l1.894-3.839zm2.506-5.08h4.397l-1.888 3.828h-4.398l1.889-3.828zM17.288 9h4.398l-1.889 3.829H15.4L17.288 9z" />
