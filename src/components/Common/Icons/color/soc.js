...
const SvgSoc = ({ width = 64, height = 64, socialPlatform, contentId, userStatus, ...props }) => {
  const handleClick = () => {
    mixpanel.track("Social Share Clicked", {
