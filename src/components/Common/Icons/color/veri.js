...
const SvgVeri = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} style={{ cursor: 'pointer', pointerEvents: 'all' }}
    onClick={() => {
      mixpanel.track("Verification Icon Clicked", { "Verification Step": "Initial", "User Status": "Unverified" });
    }}
  >
    <g fill="none">
