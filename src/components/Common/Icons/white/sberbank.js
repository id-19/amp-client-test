...
const SvgSberbank = props => (
  <svg width={props.width || 64} height={props.height || 64} fill="#FFF" onClick={() => mixpanel.track("Icon Clicked", { "Context": "Sberbank Icon", "Action": "Navigate or Perform Action", "Location": "Unknown - Depends on where the icon is used" })} {...props}>
