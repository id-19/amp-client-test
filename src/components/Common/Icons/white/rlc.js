...
const SvgRlc = props => {
  // Event handler to track SVG clicks
  const handleSvgClick = () => {
    mixpanel.track("SVG Icon Clicked", {
      "Icon": "rlc",
      "Context": "Common Icons",
      "Path": "src/components/Common/Icons/white/rlc.js"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} fill="#FFF" fillRule="evenodd" {...props} onClick={handleSvgClick} // Added onClick event handler for tracking
    >
