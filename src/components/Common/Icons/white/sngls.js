...
const SvgSngls = props => (
  <svg width={props.width || 64} height={props.height || 64} fill="#FFF" fillRule="evenodd" {...props} onClick={() => Mixpanel.track("Icon Click", {"Context": "Assuming Usage Context", "Action": "Assumed Action"})}>
