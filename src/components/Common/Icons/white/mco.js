...
const SvgMco = props => (
  <svg width={props.width || 64} height={props.height || 64} fill="#FFF" fillRule="evenodd" className="svg-icon-mco"
    onClick={() => mixpanel.track("Icon Clicked", {"Icon Name": "Mco", "Context": "Unknown - Specify where used"})}
    {...props}
  >
