...
const SvgXcp = props => (
  <svg width={props.width || 64} height={props.height || 64} fill="#FFF" fillRule="evenodd" {...props} onClick={() => mixpanel.track("Icon Click", { "Icon": "Xcp", "Context": "Assumed to be used within a clickable element" })} style={{ pointerEvents: 'all' }}>
