...
const SvgItc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#itc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#itc_svg__b" />
    ...
    <button type="button" aria-label="Share" className="share-button" onClick={() => mixpanel.track("Share Button Clicked", { "Icon": "SvgItc", "Action": "Share", "Context": "Hypothetical use case - exact context depends on where the button is used" })} >
      Share
    </button>
  </svg>
);
