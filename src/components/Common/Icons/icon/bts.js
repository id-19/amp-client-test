...
const SvgBts = props => {
  ...
  return (
    <div onClick={handleIconClick} style={{ cursor: 'pointer' }}>
      {/* Make the div clickable and indicate it's interactive */}
