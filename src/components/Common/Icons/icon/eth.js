...
const SvgEth = props => {
  // Track Icon View event when the component mounts
  useEffect(() => {
    mixpanel.track("Icon View", {
      "Context": "Ethereum Icon",
      "Visibility": "Visible"
    });
  }, []);
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      <defs>
        ...
        <path id="eth_svg__e" d="M16.498 20.968L24 16.616l-7.502 10.379L9 16.615l7.498 4.351zm0-17.968l7.497 12.22-7.497 4.353L9 15.22 16.498 3z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#eth_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#eth_svg__b" />
