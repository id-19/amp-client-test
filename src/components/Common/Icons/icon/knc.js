...
const SvgKnc = props => {
  const trackIconClick = () => {
    mixpanel.track("Icon Click", {
      "Icon Name": "Knc",
      "Action": "Click",
      "Context": "Icons Component"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconClick} style={{ cursor: 'pointer' }}>
      <defs>
        ...
        <path id="knc_svg__e" d="M15.086 13.462l6.676 7.018L15.245 26l-.159-12.538zm.318-.473L22 9.677l-.238 10.094-6.358-6.782zm-.397-.552V4l6.914 5.204-6.914 3.233zm-.477-8.2l.238 21.211-3.655-5.125L10 9.362l4.53-5.125z" />
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#knc_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#knc_svg__b" />
