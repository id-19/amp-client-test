...
const SvgRdn = props => {
  // Track "Icon Displayed" event on component mount
  useEffect(() => {
    mixpanel.track("Icon Displayed", {
      "Icon Name": "Rdn",
  ...
  // Handler for tracking "Icon Clicked" event
  const handleClick = () => {
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#rdn_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rdn_svg__b" />
