...
const SvgNlg = props => (
  <div onClick={() => mixpanel.track("Icon Click", {"Icon Name": "nlg", "Context": "Unknown - requires further context"})}>
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#nlg_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#nlg_svg__b" />
