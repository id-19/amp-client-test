...
const SvgNano = props => {
  const handleIconClick = () => {
    Mixpanel.track("Icon Interaction", {
      "Icon Name": "Nano",
      "Action": "Click",
      "Context": "Unknown - Depends on where the SVG is used"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#nano_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#nano_svg__b" />
