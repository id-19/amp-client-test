...
const SvgQiwi = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Action": "Click",
      "Icon Name": "Qiwi",
      "Context": "Unknown - Specify where used" // Update this based on actual usage context
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#qiwi_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#qiwi_svg__b" />
