...
const SvgAtm = props => {
  ...
  const handleSvgClick = () => {
    mixpanel.track("ATM Locator Opened", {
      "Icon": "ATM",
      "Action": "Click",
  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#atm_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#atm_svg__b" />
