  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconInteraction}>
      ...
      <g fill="none">
        ...
        <use fill="url(#mona_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mona_svg__b" />
