...
const SvgPart = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", { "Icon Name": "SvgPart", "Action": "Click", "Context": "Unknown - Depends on where and how the icon is used" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#part_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#part_svg__b" />
