...
const SvgCnd = props => {
  ...
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Action": "Click",
      "Icon Name": "Cnd",
      "Context": "Where it is used, e.g., Footer Social Link"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#cnd_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#cnd_svg__b" />
