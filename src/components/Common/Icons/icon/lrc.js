...
const SvgLrc = props => {
  useEffect(() => {
    Mixpanel.track("Icon Viewed", {
      "Icon Name": "LRC",
      "Context": "Unknown - Define based on usage",
      "Purpose": "Unknown - Define based on usage"
    });
  }, []);
  ...
  const handleClick = () => {
    Mixpanel.track("Icon Clicked", {
      ...
      "Context": "Unknown - Define based on usage",
      "Purpose": "Unknown - Define based on usage",
      "Action": "Unknown - Define based on interaction"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      <defs>
        ...
        <path id="lrc_svg__e" d="M16 5l9 12.533L16 25l-9-7.467L16 5zm-1.174 6.667L10.913 17l3.913 3.2v-8.533zm2.348 0V20.2l3.913-3.2-3.913-5.333z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#lrc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#lrc_svg__b" />
