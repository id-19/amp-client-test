...
const SvgPayx = props => {
  useEffect(() => {
    mixpanel.init('YOUR_MIXPANEL_TOKEN'); // Initialize Mixpanel. Replace 'YOUR_MIXPANEL_TOKEN' with your actual Mixpanel token.
  }, []);

  const handleIconClick = () => {
    mixpanel.track("Payment Icon Clicked", {
      "Icon": "Payx",
      "Action": "Clicked",
      ...
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none">
          <g transform="translate(1)">
            ...
            <use fill="url(#payx_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#payx_svg__b" />
