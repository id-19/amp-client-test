...
const SvgIgnis = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Click", { "Icon Name": "Ignis", "Action": "Click", "Context": "Unknown - Depends on where and how the icon is used" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#ignis_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ignis_svg__b" />
