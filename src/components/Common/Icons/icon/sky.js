...
const SvgSky = props => {
  const handleClick = () => {
    mixpanel.track("Icon Click", {
      "Icon Name": "SvgSky",
      "Action": "Click",
      "Context": "Assuming wrapped in clickable element"
    });
  };
    ...
    <div onClick={handleClick} style={{ cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none">
          ...
          <use fill="url(#sky_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#sky_svg__b" />
