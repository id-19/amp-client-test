...
// Assuming Mixpanel is initialized and imported correctly
import mixpanel from 'mixpanel-browser';

const SvgActn = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", { "Context": "Feature Button", "Icon Name": "Actn", "Action": "Click" })} >
    <defs>
