...
const SvgBay = props => {
  ...
  return (
    <div onClick={handleSvgClick} style={{ cursor: 'pointer' }}>
      {/* Adding a wrapper div with onClick */}
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#bay_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bay_svg__b" />
