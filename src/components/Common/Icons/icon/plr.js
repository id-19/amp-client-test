...
const SvgPlr = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Logo Clicked", {"Context": "Header", "Visible": "True"})} // Event tracking added here
  >
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#plr_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#plr_svg__b" />
