...
const SvgDent = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", {"Icon Name": "Dent", "Action": "Click"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#dent_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#dent_svg__b" />
