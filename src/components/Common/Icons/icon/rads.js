...
const SvgRads = props => {
  const handleClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon Name": "Rads",
      "Action": "Click",
      "Context": "To be defined based on where SvgRads is used"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#rads_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rads_svg__b" />
