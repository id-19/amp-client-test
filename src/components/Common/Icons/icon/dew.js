...
const SvgDew = props => (
  <button type="button" aria-label="View Details" className="AssumedClassNameOrID"
    onClick={() => Mixpanel.track("View Details Clicked", {
      "Icon": "Dew",
      "Action": "View Details",
  ...
  >
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#dew_svg__c)" style={{mixBlendMode: 'soft-light',}} xlinkHref="#dew_svg__b" />
