    ...
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#oot_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#oot_svg__b" />
      ...
      <button type="button" className="sign-up-button" onClick={handleButtonClick} style={{position: 'absolute', opacity: 0, pointerEvents: 'none'}}>
        Sign Up
      </button>
    </svg>
  );
