...
const SvgDgd = props => {
  ...
  return (
    <>
      <button onClick={handleClick} type="submit" className="classname or id of the button">
        <svg width={props.width || 64} height={props.height || 64} {...props}>
          <defs>
            ...
            <path id="dgd_svg__e" d="M12.5 10v3h-7v-3h7zm1 0h2v10h-10v-6h8v-4zm-6 6v2h6v-2h-6zm19-4h-8v6h6v-2h-4v-2h6v6h-10V10h10v2z" />
          ...
          <g fill="none" fillRule="evenodd">
            ...
            <use fill="url(#dgd_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#dgd_svg__b" />
