...
const SvgAgrs = props => {
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackInteraction}>
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#agrs_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#agrs_svg__b" />
