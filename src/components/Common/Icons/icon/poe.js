...
const SvgPoe = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon": "Poe",
      "Action": "Clicked",
      "Context": "Assume context where the icon is used"
    });
  };

  return (
    <button type="button" onClick={handleIconClick} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#poe_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#poe_svg__b" />
