...
const SvgPot = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => {
    mixpanel.track("Pot Icon Clicked", {
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#pot_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#pot_svg__b" />
