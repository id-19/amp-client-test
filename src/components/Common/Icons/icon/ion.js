...
const SvgIon = props => {
  ...
  const handleClick = () => {
    // Track the "Icon Clicked" event
    mixpanel.track("Icon Clicked", {
      "Icon Name": "SvgIon",
      "Context": "TBD based on where and how the icon is used"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#ion_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ion_svg__b" />
