...
const SvgNdz = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Click", { "Icon": "Ndz", "Action": "Sign Up", "Context": "Sign Up Button" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      <g fillRule="nonzero">
        ...
        <use fill="url(#ndz_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ndz_svg__b" />
