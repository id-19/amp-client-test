    ...
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none">
        <g transform="translate(1)">
          ...
          <use fill="url(#sib_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#sib_svg__b" />
          <circle strokeOpacity={0.097} stroke="#000" strokeLinejoin="square" cx={15} cy={15} r={14.5} />
        </g>
        <path d="M16 4C9.925 4 5 8.925 5 15s4.925 11 11 11 11-4.925 11-11A11 11 0 0 0 16 4zm3.828 15.15h-.448v2.504h-1.502V19.15h-2.29v-.93h2.326v-1.682a5.902 5.902 0 0 1-3.97.644c-.752-.179-1.503-.59-1.897-1.27a4.205 4.205 0 0 1-.536-2.182V9.76h1.52v4.113c.036.894.608 1.789 1.484 2.057a4.577 4.577 0 0 0 3.38-.537c0-1.252-.017-3.13 0-5.634h1.54v8.46h.393v.93z" fill="#FFF" />
      </g>
    </svg>
  );
};
