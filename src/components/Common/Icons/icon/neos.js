...
const SvgNeos = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Action": "Click",
      "Icon Name": "Neos",
      "Context": "Assuming it's used for a specific feature or link"
    });
  };

  return (
    <div role="button" onClick={handleIconClick} style={{ cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="neos_svg__e" d="M10.5 8.358l8.143 4.926v3.097l-5.714-3.433V25H10.5V8.358zm11 13.284l-8.143-4.926V13.62l5.714 3.433V5H21.5v16.642z" />
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#neos_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#neos_svg__b" />
