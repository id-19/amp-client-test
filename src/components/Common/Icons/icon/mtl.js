...
const SvgMtl = props => {
  // Event handler to track SVG Icon Interaction
  const handleSvgClick = () => {
    mixpanel.track("SVG Icon Interaction", {
      "Action": "Click",
      "Icon Name": "Mtl",
      "Page": "Unknown - Implementer to specify"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick} // Attach the click event handler
    >
      <defs>
      ...
      <g fill="none">
        ...
        <use fill="url(#mtl_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mtl_svg__b" />
