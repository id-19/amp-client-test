...
const SvgCvc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("CVC Info Clicked", { "Context": "Form", "Icon": "CVC Info", "Action": "Clicked to learn about CVC" })}>
    <defs>
    ...
    <g fill="none">
      ...
      <use fill="url(#cvc_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#cvc_svg__b" />
