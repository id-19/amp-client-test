...
const SvgRpx = props => {
  useEffect(() => {
    mixpanel.track("SVG Icon Rendered", {
      "Icon Name": "rpx",
      "Context": "Unknown - requires further analysis"
    });
  }, []);
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none">
        ...
        <use fill="url(#rpx_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rpx_svg__b" />
