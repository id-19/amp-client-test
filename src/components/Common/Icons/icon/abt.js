...
const SvgAbt = props => {
  ...
  return (
    <button type="button" aria-label="Sign up" className="signup-button" onClick={trackSignUpClick}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="abt_svg__e" d="M6.5 9.487L16 4l9.5 5.487v11.026L16 26l-9.5-5.487V9.487zm.912 9.97l3.81-2.205 1.933-3.385-5.743-3.323v8.913zm.457.791l7.702 4.449V20.44l-4.038-2.313-3.664 2.12zm16.719-9.673l-5.692 3.293 1.932 3.382 3.76 2.176v-8.851zm-.43-.808l-7.675-4.433v4.309l1.96 3.431 5.715-3.307zm-6.047 4.555L16.939 15l2.325 1.345-1.153-2.023zm-.453-.794l-1.175-2.06v2.74l1.175-.68zm-4.864 2.815L15.114 15l-1.169-.676-1.15 2.019zm-.346 1.256l3.123 1.788v-3.595l-3.123 1.807zm-4.58-7.847l5.74 3.32 1.963-3.435V5.303L7.868 9.752zm16.29 10.481l-3.636-2.104-4.039 2.341v4.196l7.675-4.433zm-4.548-2.632l-3.127-1.809v3.622L19.61 17.6zm-5.212-4.071l1.173.678v-2.735l-1.173 2.057z" />
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#abt_svg__c)" style={{mixBlendMode: 'soft-light',}} xlinkHref="#abt_svg__b" />
