...
// Assuming Mixpanel is initialized in another file and imported here
  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#tau_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#tau_svg__b" />
