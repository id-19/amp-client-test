...
const SvgCnx = props => {
  ...
  const handleClick = () => {
    mixpanel.track("Icon Click", {
      "Icon": "Cnx",
      "Context": "TBD" // Replace "TBD" with the actual context when known
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#cnx_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#cnx_svg__b" />
        <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
        <g fill="#FFF" filter="url(#cnx_svg__d)" transform="translate(5 4)">
          <path d="M1.383 12.01L0 12.153c.74-2.07 2.203-3.726 4.391-4.968.207 1.716 1.02 3.135 2.44 4.259l-1.3.135a5.503 5.503 0 0 0 4.553 4.845 6.084 6.084 0 0 1-2.987 1.185c.681 1.2 1.487 2.183 2.417 2.947a9.674 9.674 0 0 1-8.131-8.546zm19.234-2.02L22 9.847c-.74 2.07-2.203 3.726-4.391 4.968-.207-1.716-1.02-3.135-2.44-4.259l1.3-.135a5.503 5.503 0 0 0-4.626-4.857 6.085 6.085 0 0 1 2.972-1.173c-.687-1.209-1.499-2.196-2.438-2.963a9.674 9.674 0 0 1 8.24 8.562z" opacity={0.5} />
