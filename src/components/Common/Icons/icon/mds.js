...
const SvgMds = props => (
  <button type="button" className="HypotheticalShareButton" onClick={() => mixpanel.track("Share Button Clicked", { "Content Type": "Post/Image/Video", "Content ID": "Unique Identifier", "Initiated From": "Mobile/Desktop" })} aria-label="Share" >
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#mds_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mds_svg__b" />
