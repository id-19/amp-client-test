...
const SvgBlcn = props => {
  const trackIconInteraction = () => {
    mixpanel.track("Icon Interaction", {
      "Icon": "SvgBlcn",
      "Action": "Assumed action, e.g., 'Open Menu'",
      "Location": "Assumed location in the app, e.g., 'Header'"
    });
  };

  return (
    <button type="button" aria-label="Assumed purpose of the button, e.g., 'Open Menu'" className="Assumed button classname or id where SvgBlcn is used" onClick={trackIconInteraction} >
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#blcn_svg__c)" style={{ mixBlendMode: 'soft-light' }} xlinkHref="#blcn_svg__b" />
