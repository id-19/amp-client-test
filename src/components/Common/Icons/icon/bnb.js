...
const SvgBnb = props => {
  // Handler to track the SVG icon click event
  const handleIconClick = () => {
    Mixpanel.track("SVG Icon Click", {
      "Icon": "Bnb",
      "Action": "Click",
      "Context": "Assumed to be used as a clickable icon"
    });
  };

  return (
    <button onClick={handleIconClick} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="bnb_svg__e" d="M12.116 13.404L16 9.52l3.886 3.886 2.26-2.26L16 5l-6.144 6.144 2.26 2.26zM6 15l2.26-2.26L10.52 15l-2.26 2.26L6 15zm6.116 1.596L16 20.48l3.886-3.886 2.26 2.259L16 25l-6.144-6.144-.003-.003 2.263-2.257zM21.48 15l2.26-2.26L26 15l-2.26 2.26L21.48 15zm-3.188-.002h.002V15L16 17.294l-2.291-2.29-.004-.004.004-.003.401-.402.195-.195L16 12.706l2.293 2.293z" />
        ...
        <g fill="none">
          ...
          <use fill="url(#bnb_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bnb_svg__b" />
