...
const SvgBdl = props => {
  ...
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      ...
      "Location": "src/components/Common/Icons/icon/bdl.js"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#bdl_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bdl_svg__b" />
