...
const SvgRcn = props => {
  useEffect(() => {
    mixpanel.track("SVG Icon Rendered");
  }, []);
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#rcn_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rcn_svg__b" />
