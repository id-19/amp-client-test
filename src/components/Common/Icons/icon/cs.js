...
const SvgCs = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", { "Icon": "SvgCs", "Action": "Part of Sign Up Button Click", "Context": "Homepage" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#cs_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#cs_svg__b" />
