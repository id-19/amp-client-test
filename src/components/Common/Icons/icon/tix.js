...
import mixpanel from 'mixpanel-browser'; // Assuming mixpanel-browser is the package used
  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      <g fillRule="nonzero">
        ...
        <use fill="url(#tix_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#tix_svg__b" />
