...
const SvgBcd = props => {
  const handleIconInteraction = () => {
    mixpanel.track("Icon Interaction", {
      ...
      "Context": "Specific feature or page name"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconInteraction} >
      ...
      <g fill="none">
        ...
        <use fill="url(#bcd_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bcd_svg__b" />
