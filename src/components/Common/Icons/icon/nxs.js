...
const SvgNxs = props => {
  useEffect(() => {
    // Track the SVG icon rendered event
    mixpanel.track("SVG Icon Rendered", {
      "Icon Name": "Nxs",
      "Width": props.width || 64, // Capture dynamic width
      "Height": props.height || 64 // Capture dynamic height
    });
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd" transform="translate(1)">
        ...
        <use fill="url(#nxs_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#nxs_svg__b" />
