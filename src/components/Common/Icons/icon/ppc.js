...
const SvgPpc = props => {
  const handleIconInteraction = () => {
    mixpanel.track("Icon Interaction", {
      ...
      "Context": "Used where this icon leads or represents"
    });
  };

  return (
    <div onClick={handleIconInteraction} style={{ cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="ppc_svg__e" d="M9 6.5c12.093.447 16.756 7.706 14.415 14.183-.663 1.803-1.368 2.79-2.85 3.817.06-.26.122-.52.17-.787.876-5.053-.785-11.134-8.912-14.493 6.466 3.848 9.075 10.695 6.06 15.115C12.75 25.142 9 20.759 9 15.709V6.5z" />
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#ppc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ppc_svg__b" />
