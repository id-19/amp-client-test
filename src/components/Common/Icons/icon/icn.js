...
const SvgIcn = props => {
  const trackIconClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "SvgIcn",
      "Context": "Unknown - Assume parent component usage",
      "Action": "Click"
    });
  };

  return (
    <div onClick={trackIconClick} style={{ cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="icn_svg__e" d="M20.833 6H23.5v18h-2.667V6zm-4.444 9h2.667v9h-2.667v-9zm-4.445-4.5h2.667V24h-2.667V10.5zm-4.444 9h2.667V24H7.5v-4.5z" />
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#icn_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#icn_svg__b" />
