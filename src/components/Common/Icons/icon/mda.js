...
// Import Mixpanel if needed, depending on your project setup
const SvgMda = props => {
  ...
  return (
    ...
    >
      ...
      <g fill="none">
        ...
        <use fill="url(#mda_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mda_svg__b" />
