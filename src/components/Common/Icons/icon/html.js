...
const SvgHtml = props => {
  ...
  const handleClick = () => {
    mixpanel.track("Share via HTML Clicked", {
      "Icon": "HTML",
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#html_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#html_svg__b" />
