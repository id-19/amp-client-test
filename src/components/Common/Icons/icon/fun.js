...
const SvgFun = props => {
  const handleClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon": "Fun",
      "Action": "Click",
      "Context": "Used within interactive element"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} fill="#ED1968" role="img" onClick={handleClick} {...props}>
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#fun_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#fun_svg__b" />
