...
const SvgLun = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Clicked", {"Icon Type": "Lun", "Context": "Unknown"})} // Event tracking added here
  >
    <defs>
    ...
    <g fill="none">
      ...
      <use fill="url(#lun_svg__c)" fillRule="evenodd" style={{mixBlendMode: 'soft-light',}} xlinkHref="#lun_svg__b" />
