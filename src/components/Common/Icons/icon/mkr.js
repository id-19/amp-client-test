...
const SvgMkr = props => {
  // Event handler function for tracking the button click
  const handleButtonClick = () => {
    mixpanel.track("Create Marker Clicked", {
      "Icon": "Marker",
      "Action": "Create",
      "Location": "Assumed location or context where the button is used"
    });
  };

  return (
    <button className="create-marker-button" type="button" aria-label="Create Marker" onClick={handleButtonClick} // Attach the event handler to the button
    >
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="mkr_svg__e" d="M7.838 11.056V21.5H6v-14l9.708 7.027V21.5H13.87v-6.077l-6.032-4.367zm10.292 4.367V21.5h-1.838v-6.973L26 7.5v14h-1.838V11.056l-6.032 4.367z" />
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#mkr_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mkr_svg__b" />
