...
const SvgEtn = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    ...
    <g fill="none">
      ...
      <use fill="url(#etn_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#etn_svg__b" />
