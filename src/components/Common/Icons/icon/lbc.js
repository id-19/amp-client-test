...
const SvgLbc = props => {
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackEvent}>
      <defs>
        ...
        <path id="lbc_svg__e" d="M24.176 16.184l-.797-.199.242-.97 2.485.621-.62 2.485-.971-.242.215-.862-8.872 5.493-9.839-4.916v-3.752l10.224-6.394 9.375 4.573v1.544l-9.759 6.063-7.247-3.593.444-.896 6.749 3.346 8.813-5.476v-.363L16.303 8.59 7.02 14.396v2.58l8.787 4.39 8.37-5.182z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#lbc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#lbc_svg__b" />
