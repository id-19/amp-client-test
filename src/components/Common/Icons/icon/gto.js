...
const SvgGto = props => {
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "GTO",
      "Action": "Open Modal/Trigger Navigation",
    ...
    <div onClick={handleClick}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none">
          ...
          <use fill="url(#gto_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#gto_svg__b" />
