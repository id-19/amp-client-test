  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => trackInteraction("Click")} onMouseEnter={() => trackInteraction("Hover")}>
      <defs>
        ...
        <path id="maid_svg__e" d="M20.246 18.154v6.487L9.29 18.333c-3.24-1.897-3.034-3.077-3.034-5.64l11.263 6.512v-1.564 1.564L6.257 12.692l10.954-6.307c3.24-1.847 4.166-1.077 6.429.205l-5.631 3.256L23.64 6.59v12.615c0 3.744-1.131 4.154-3.394 5.436v-6.487z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#maid_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#maid_svg__b" />
        ...
        <g fill="#FFF" fillRule="nonzero">
          ...
          <path d="M17.52 19.205L6.257 12.692l10.954-6.307c3.24-1.847 4.166-1.077 6.429.205l-11.263 6.513 5.143 2.974v3.128z" opacity={0.6} />
          <path d="M12.377 13.103L23.64 6.59v12.615c0 3.744-1.131 4.154-3.394 5.436V11.667L15.05 14.64l-2.674-1.538z" opacity={0.2} />
        </g>
        <g fillRule="nonzero">
