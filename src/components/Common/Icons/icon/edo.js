...
const SvgEdo = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Clicked", {"Icon Name": "Edo", "Context": "Assumed context where the icon is used"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#edo_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#edo_svg__b" />
