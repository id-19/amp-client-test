...
const SvgMnz = props => {
  useEffect(() => {
    mixpanel.track("Icon Rendered", {
      "Icon Name": "Mnz",
      "Path": "src/components/Common/Icons/icon/mnz.js"
    });
  }, []);
  ...
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "Mnz",
      "Action": "Click",
      "Context": "Assuming it's wrapped in a button or link"
    });
  };
