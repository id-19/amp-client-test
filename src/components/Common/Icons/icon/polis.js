...
const SvgPolis = props => {
  const handleLogoClick = () => {
    mixpanel.track("Logo Interaction", {
      "Action": "Click",
      "Label": "Polis Logo",
      "Context": "Header"
    });
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleLogoClick}>
      <defs>
