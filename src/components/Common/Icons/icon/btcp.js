...
const SvgBtcp = props => {
  useEffect(() => {
    mixpanel.track("Icon Viewed", { "Icon Type": "BTCP", "Action": "Rendered" });
  }, []);

  const handleClick = () => {
    mixpanel.track("Icon Clicked", { "Icon Type": "BTCP", "Action": "Clicked" });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick} >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#btcp_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#btcp_svg__b" />
