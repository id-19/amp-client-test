...
const SvgPpt = props => {
  const trackDownload = () => {
    mixpanel.track("Presentation Download", {
      "Type": "PPT",
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackDownload}>
      <defs>
      ...
      <g fill="none">
        ...
        <use fill="url(#ppt_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ppt_svg__b" />
