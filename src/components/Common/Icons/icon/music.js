...
const SvgMusic = props => (
  <button 
    ...
    onClick={() => mixpanel.track("Play Music Clicked", { "Icon": "Music", "Action": "Play", "Location": "Common Icons" })}
  >
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none">
        ...
        <use fill="url(#music_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#music_svg__b" />
