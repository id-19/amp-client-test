...
const SvgSalt = props => {
  useEffect(() => {
    mixpanel.track("Icon Viewed", {
      "Icon Name": "Salt",
      "Icon Type": "SVG",
      "Usage Context": "Unknown - Requires further implementation details"
    });
  }, []);
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none">
        ...
        <use fill="url(#salt_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#salt_svg__b" />
