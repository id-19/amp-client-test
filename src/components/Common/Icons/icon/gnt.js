...
const SvgGnt = props => {
  const handleIconInteractionClick = () => {
  ...
  const handleIconInteractionHover = () => {
    mixpanel.track("Icon Interaction", {
      "Action": "Hover",
      "Icon Name": "GNT",
      "Context": "Where it's used"
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconInteractionClick} onMouseEnter={handleIconInteractionHover} >
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#gnt_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#gnt_svg__b" />
