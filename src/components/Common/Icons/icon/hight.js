    ...
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconInteraction}>
      ...
      <g fill="none">
        <g transform="translate(1)">
          ...
          <use fill="url(#hight_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#hight_svg__b" />
          <circle strokeOpacity={0.097} stroke="#000" strokeLinejoin="square" cx={15} cy={15} r={14.5} />
        </g>
        <path d="M25.622 9.805L17.87 22.582h-4.622l3.552-5.863h-3.53l-4.116 6.787A10.913 10.913 0 0 0 25.62 9.81l.003-.005zm-6.768-2.294l-3.364 5.537h3.536l3.918-6.462A10.913 10.913 0 0 0 6.48 20.281l7.748-12.77h4.626z" fill="#FFF" />
      </g>
    </svg>
  );
};
