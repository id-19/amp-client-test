...
const SvgRise = props => {
  const trackIconInteraction = () => {
    mixpanel.track("Icon Interaction", {
      "Action": "Click",
      "Icon Name": "SvgRise",
      "Context": "Assuming wrapped in a button or clickable element"
    });
  };
    ...
    <button onClick={trackIconInteraction} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#rise_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rise_svg__b" />
