...
const SvgGame = props => {
  const handleClick = () => {
    mixpanel.track("Game Icon Clicked", {
      "Context": "Used within a button or clickable area",
      "Icon": "Game",
      "Action": "Click"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#game_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#game_svg__b" />
