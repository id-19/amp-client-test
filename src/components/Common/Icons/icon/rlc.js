...
const SvgRlc = props => {
  ...
  return (
    <button type="button" aria-label="Play Video" className="className or id of the button" onClick={trackIconClick}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#rlc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rlc_svg__b" />
