...
const SvgData = props => {
  useEffect(() => {
    mixpanel.track("SVG Icon Rendered", {
      "Icon": "Data",
      "Path": "src/components/Common/Icons/icon/data.js"
    });
  }, []);
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none">
        ...
        <use fill="url(#data_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#data_svg__b" />
