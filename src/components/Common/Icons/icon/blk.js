...
const SvgBlk = props => {
  const handleSvgClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "blk",
      "Context": "TBD based on implementation",
      "Page": "TBD"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#blk_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#blk_svg__b" />
