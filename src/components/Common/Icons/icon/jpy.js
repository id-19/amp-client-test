  ...
  return (
    ...
    >
      <defs>
        ...
        <path id="jpy_svg__e" d="M17.548 17.711v1.878h5.063v2.288h-5.063V24.5h-3.096v-2.623H9.389v-2.288h5.063v-1.878H9.389v-2.288h4.171L7.5 6.5h3.752l4.8 7.534L20.853 6.5H24.5l-6.086 8.923h4.197v2.288z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#jpy_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#jpy_svg__b" />
