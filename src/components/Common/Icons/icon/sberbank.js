...
const SvgSberbank = props => {
  // Track "Icon Viewed" event on component mount
  useEffect(() => {
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => {
      // Track "Icon Clicked" event on click
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#sberbank_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#sberbank_svg__b" />
