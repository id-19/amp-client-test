...
const SvgGsc = props => (
  <div className="svg-icon-clickable" onClick={() => Mixpanel.track("Icon Clicked", {"Icon Name": "GSC", "Context": "Unknown", "Action": "Click"})}>
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none">
        <g transform="translate(1)">
          ...
          <use fill="url(#gsc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#gsc_svg__b" />
          <circle strokeOpacity={0.097} stroke="#000" strokeLinejoin="square" cx={15} cy={15} r={14.5} />
        </g>
        <path d="M24.163 11.442H15.93a3.488 3.488 0 1 0 3.265 4.702H15.93a.92.92 0 0 1-.92-.92v-.112a.92.92 0 0 1 .92-.921h5.442c.04.254.059.51.056.767a5.498 5.498 0 1 1-5.498-5.525l.168-.028a.328.328 0 0 0 .111.028h4.884c2.665 0 3.754-1.424 3.754-3.433H15.93a8.93 8.93 0 1 0 8.93 8.972v-2.819a.698.698 0 0 0-.697-.711z" fill="#FFF" />
      </g>
    </svg>
  </div>
);
