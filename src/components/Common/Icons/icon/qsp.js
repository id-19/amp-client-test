...
const SvgQsp = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon Name": "QSP",
      "Action": "Click",
      "Context": "Unknown - Suggest wrapping in a button or link for interaction tracking"
    });
  };
    ...
    <button onClick={handleIconClick} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#qsp_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#qsp_svg__b" />
