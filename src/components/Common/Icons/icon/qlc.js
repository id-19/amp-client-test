...
const SvgQlc = props => (
  <div onClick={() => mixpanel.track("Icon Click", {"Icon Name": "Qlc", "Action": "Click", "Context": "Assuming wrapped in a clickable element"})}>
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#qlc_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#qlc_svg__b" />
