...
const SvgRhoc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => {
    mixpanel.track("Icon Click", {
      "Icon Name": "Rhoc",
      "Context": "User clicked on the Rhoc icon",
    ...
    <g fill="none">
      ...
      <use fill="url(#rhoc_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rhoc_svg__b" />
