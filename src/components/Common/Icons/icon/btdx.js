...
const SvgBtdx = props => {
  // Function to handle event tracking
  const handleSvgInteraction = () => {
    mixpanel.track("Icon Interaction", {
      "Context": "Hypothetical use case - wrapped in a button or link",
      "Action": "Submit",
      "Location": "Form or Page Name"
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgInteraction}>
      <defs>
      ...
      <g fill="none">
        <g transform="translate(1)">
          ...
          <use fill="url(#btdx_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#btdx_svg__b" />
