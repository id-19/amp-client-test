  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconInteraction}>
      ...
      <g fill="none">
        ...
        <use fill="url(#sys_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#sys_svg__b" />
