...
const SvgBlock = props => {
  useEffect(() => {
    mixpanel.track("SVG Icon Visible", {
      "Icon Name": "SvgBlock",
      "Context": "Specify the context if known, e.g., 'User Profile Page'",
      "Visibility": "True"
    });
  }, []);
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      <defs>
        ...
        <path id="block_svg__e" d="M5.522 0H15.75L21 9l-5.25 9H5.431l5.16-9-5.07-9zm5.43 3.166L14.303 9l-3.35 5.834h2.988L17.289 9l-3.35-5.834h-2.986z" />
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#block_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#block_svg__b" />
