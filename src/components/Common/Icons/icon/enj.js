...
const SvgEnj = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    ...
    <g fill="none">
      ...
      <use fill="url(#enj_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#enj_svg__b" />
