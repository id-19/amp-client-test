...
const SvgOk = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Ok Icon Clicked", {"Context": "Confirmation", "Action": "Agree"})} >
    <defs>
