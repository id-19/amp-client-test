...
const SvgElla = props => {
  const handleClick = (e) => {
    ...
    window.mixpanel.track("Icon Clicked", {
      "Icon Name": "SvgElla",
      "Context": "Assuming usage context"
    });
  };
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      <defs>
        ...
        <path id="ella_svg__e" d="M18.073 12.212L16 10.14l-2.087 2.086-2.164-2.164L16 4l4.28 6.005-2.207 2.207zm-4.883.738L11.14 15l2.072 2.073-2.156 2.156L5 15l5.99-4.25 2.2 2.2zm5.584 4.137L20.86 15l-2.064-2.064 2.226-2.226L27 15l-6.044 4.269-2.182-2.182zm-4.838.71L16 19.86l2.05-2.05 2.182 2.183L16 26l-4.204-6.064 2.14-2.14zM16 11.527L19.472 15 16 18.472 12.528 15 16 11.528z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#ella_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ella_svg__b" />
