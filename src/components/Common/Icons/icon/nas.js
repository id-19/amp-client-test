...
const SvgNas = props => {
  useEffect(() => {
    mixpanel.init('YOUR_MIXPANEL_PROJECT_TOKEN'); // Initialize Mixpanel. Replace 'YOUR_MIXPANEL_PROJECT_TOKEN' with your actual Mixpanel project token.
  }, []);
  ...
  const handleIconClick = () => {
    mixpanel.track("Share Icon Clicked", {
      "Icon": "NAS",
      "Action": "Share",
      "Context": "Assumed to be within a button or clickable element"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#nas_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#nas_svg__b" />
