...
const SvgBlz = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", {"Icon Name": "Blz", "Action": "Click"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#blz_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#blz_svg__b" />
