...
const SvgR = props => {
  const handleClick = () => {
    mixpanel.track("Icon Click", {
      "Icon Name": "SvgR",
      "Purpose": "Unknown - Specify based on usage context",
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      <defs>
        ...
        <path id="r_svg__e" d="M10.5 23.638l3.467-1.812V9.745l4.952 2.778-3.714 1.933v3.987L23.5 24v-3.745l-5.076-3.503 4.209-2.175v-3.866L13.967 6 10.5 7.812z" />
      ...
      <g fill="none">
        ...
        <use fill="url(#r_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#r_svg__b" />
