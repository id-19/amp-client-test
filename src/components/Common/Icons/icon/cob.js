...
const SvgCob = props => {
  const handleClick = () => {
    mixpanel.track("User Profile Accessed", {
      "Icon": "Cob",
      "Action": "Click",
    ...
    <div onClick={handleClick} style={{ cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#cob_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#cob_svg__b" />
