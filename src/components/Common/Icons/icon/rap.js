    ...
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none">
        <g transform="translate(1)">
          ...
          <use fill="url(#rap_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rap_svg__b" />
          <circle strokeOpacity={0.097} stroke="#000" strokeLinejoin="square" cx={15} cy={15} r={14.5} />
        </g>
        <path d="M12.478 5.435v19.478H9V5h3.478v.435zM14.957 5h1.956c4.044 0 6.74 2.565 6.74 6.217 0 2.957-1.61 5.218-4.523 5.957l5.087 7.739H20.13L13.174 14.13h3.348c2.217 0 3.608-1 3.608-2.956 0-1.957-1.39-2.957-3.608-2.957H15V5h-.043z" fill="#FFF" />
      </g>
    </svg>
  );
};
