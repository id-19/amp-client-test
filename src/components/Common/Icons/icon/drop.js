...
const SvgDrop = props => {
  ...
  const handleClick = () => {
    mixpanel.track("Icon Click", {
      "Icon": "Drop",
      "Action": "Click",
      "Context": "Assumed context where used"
    });
  };

  return (
    <button className="drop-icon-button" type="button" aria-label="Drop Icon" onClick={handleClick} >
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none">
          <g transform="translate(1)">
            ...
            <use fill="url(#drop_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#drop_svg__b" />
