...
const SvgAst = props => (
  <div onClick={() => mixpanel.track("Icon Interaction", {"Icon Name": "SvgAst", "Action": "Click", "Context": "Sign Up Button"})}>
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#ast_svg__c)" style={{mixBlendMode: 'soft-light',}} xlinkHref="#ast_svg__b" />
