...
const SvgAppc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Clicked", {"Icon Name": "appc", "Context": "Unknown - Specify where used"})} // Adding the onClick event handler for Mixpanel tracking
  >
    <defs>
    ...
    <g fill="none">
      ...
      <use fill="url(#appc_svg__c)" fillRule="evenodd" style={{mixBlendMode: 'soft-light',}} xlinkHref="#appc_svg__b" />
