...
const SvgCdt = props => {
  ...
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Type": "cdt",
      "Context": "Unknown - Requires further implementation detail"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#cdt_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#cdt_svg__b" />
