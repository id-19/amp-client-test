...
const SvgChips = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => Mixpanel.track("Icon Interaction", { "Icon": "Chips", "Action": "Click" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      <g fillRule="nonzero">
        ...
        <use fill="url(#chips_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#chips_svg__b" />
