...
// Import Mixpanel tracking library
...
const SvgMcap = props => {
  ...
  const trackIconClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "MCap",
      "Context": "Assumed part of a clickable element"
    });
  };

  return (
    // Wrap the SVG in a div that's clickable and accessible, with an `onClick` event handler
    <div onClick={trackIconClick} role="button" tabIndex="0" aria-label="MCap Icon">
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#mcap_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mcap_svg__b" />
