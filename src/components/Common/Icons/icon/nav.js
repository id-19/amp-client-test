    ...
    <div onClick={handleClick} style={{ cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="nav_svg__e" d="M21.32 21h-4.796l-3.798-7.005L9.797 21H5l5.018-12h4.797l3.945 7.276L22.203 9H27l-5.68 12z" />
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <use fill="url(#nav_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#nav_svg__b" />
