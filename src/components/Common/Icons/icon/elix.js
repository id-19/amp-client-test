...
const SvgElix = props => {
  useEffect(() => {
    ...
    const svgElement = document.getElementById('SvgElixIcon');
    if (svgElement) {
  ...
  return (
    <svg id="SvgElixIcon" width={props.width || 64} height={props.height || 64} {...props}>
      <defs>
      ...
      <g fill="none">
        ...
        <use fill="url(#elix_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#elix_svg__b" />
        ...
        <g fill="#FFF" filter="url(#elix_svg__d)" transform="translate(10 5)">
          ...
          <path fillOpacity={0.5} d="M5.985 15.29v4.651l-5.89-2.344 5.89-2.315V9.984l-5.89-7.62 5.89 2.31V.023l5.89 2.343-5.89 2.315V9.98l5.89 7.62-5.89-2.31z" />
          <path fillOpacity={0.145} d="M.095 2.366L5.985.023V4.68L.095 2.366zm11.78 15.231l-5.89 2.344v-4.659l5.89 2.315z" />
        </g>
      </g>
    </svg>
  );
