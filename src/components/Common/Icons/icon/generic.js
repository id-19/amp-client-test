...
const SvgGeneric = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => Mixpanel.track("Icon Clicked", {"Icon Name": "Generic", "Icon Purpose": "Unknown"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      <g fillRule="nonzero">
        ...
        <use fill="url(#generic_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#generic_svg__b" />
