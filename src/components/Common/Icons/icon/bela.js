...
const SvgBela = props => {
  const trackIconClick = () => {
    mixpanel.track("Icon Click", {
      "Icon Name": "Bela",
      "Context": "Unknown - requires further context from application usage"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconClick}>
      <defs>
        ...
        <path id="bela_svg__e" d="M8.297 10.568A2.422 2.422 0 0 1 7 8.422a2.416 2.416 0 1 1 4.553-1.134 8.891 8.891 0 0 1 4.501-1.216c4.94 0 8.946 4.014 8.946 8.964S20.995 24 16.054 24c-4.94 0-8.946-4.013-8.946-8.964a8.94 8.94 0 0 1 1.189-4.468zm7.757 8.878c2.43 0 4.4-1.974 4.4-4.41 0-2.435-1.97-4.41-4.4-4.41-2.43 0-4.4 1.975-4.4 4.41 0 2.436 1.97 4.41 4.4 4.41z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#bela_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bela_svg__b" />
