...
// Assuming Mixpanel is initialized elsewhere and is imported here
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#mod_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#mod_svg__b" />
