...
const SvgTaas = props => {
  ...
  const handleIconClick = () => {
    mixpanel.track("Icon Interaction", {
      ...
      "Page URL": window.location.href // Dynamically capturing the page URL
    });
  };
  ...
  return (
    ...
    >
      ...
      <g fill="none">
        ...
        <use fill="url(#taas_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#taas_svg__b" />
