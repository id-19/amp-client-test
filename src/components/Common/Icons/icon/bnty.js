...
const SvgBnty = props => {
  const handleIconClick = () => {
    Mixpanel.track("Bounty Icon Clicked", {
      "Section": "Bounty",
      "Action": "Navigate",
      "Label": "Bounty Feature"
    });
  };

  return (
    <button type="button" aria-label="View Bounty" className="className or id of the button wrapping the SVG" // Placeholder for actual className or id
    ...
    >
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none">
          ...
          <use fill="url(#bnty_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bnty_svg__b" />
