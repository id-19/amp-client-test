...
const SvgGusd = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => {
    mixpanel.track("GUSD Icon Interaction", {
      "Action": "Click",
      "Location": "Common Icon Component",
      "Purpose": "Information or Transaction Initiation"
    });
  }} >
    <defs>
