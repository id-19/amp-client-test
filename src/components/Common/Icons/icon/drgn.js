...
const SvgDrgn = props => {
  useEffect(() => {
    mixpanel.track("Icon Rendered", {
      "Icon Name": "Drgn",
      "Width": props.width || "64", // Dynamic width
      "Height": props.height || "64" // Dynamic height
    });
  }, [props.width, props.height]); // Track changes to width and height
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#drgn_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#drgn_svg__b" />
