...
const SvgSphtx = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Click", { "Icon Name": "SvgSphtx", "Action": "Unknown - Define based on usage context", "Location": "Common Icons" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#sphtx_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#sphtx_svg__b" />
