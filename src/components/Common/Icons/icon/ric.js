...
const SvgRic = props => {
  useEffect(() => {
    // Assuming Mixpanel is already initialized elsewhere in the application
    mixpanel.track("SVG Viewed", {
      "Icon Name": "Ric",
      "Width": props.width || 64,
      "Height": props.height || 64
    });
  }, [props.width, props.height]); // Re-fire if width or height props change

  const handleClick = () => {
    mixpanel.track("SVG Clicked", {
      "Icon Name": "Ric",
      "Action": "Container element action required",
      "Context": "Depends on where and how the SVG is used"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick} >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#ric_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ric_svg__b" />
