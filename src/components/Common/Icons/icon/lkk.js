  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      <defs>
        ...
        <path id="lkk_svg__e" d="M10.005 25v-3.656L16 15.24l5.976 6.105V25L16 18.894 10.005 25zM5 12.633h8.469L16 15.24H7.531L5 12.633zm22 0l-2.531 2.606H16V4l2.531 2.586v6.047H27z" />
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#lkk_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#lkk_svg__b" />
