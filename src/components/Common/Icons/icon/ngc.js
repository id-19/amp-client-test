...
const SvgNgc = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", {"Icon Name": "Ngc", "Action": "Click"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#ngc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ngc_svg__b" />
