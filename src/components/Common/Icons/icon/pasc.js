...
const SvgPasc = props => {
  // Event tracking handler for the SVG element
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick} // Adding the onClick event handler for tracking
    >
      <defs>
