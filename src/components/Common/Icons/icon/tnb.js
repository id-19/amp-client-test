...
const SvgTnb = props => (
  <div 
    role="button" 
    tabIndex="0" 
    onClick={() => Mixpanel.track("Sign Up Icon Clicked", { Icon: "Tnb", Context: "Sign Up Button" })}
    onKeyPress={(e) => {
      if (e.key === 'Enter' || e.key === ' ') {
        Mixpanel.track("Sign Up Icon Clicked", { Icon: "Tnb", Context: "Sign Up Button" });
      }
    }} 
  ...
  >
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#tnb_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#tnb_svg__b" />
