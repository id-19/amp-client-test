    ...
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconInteraction}>
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#deez_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#deez_svg__b" />
