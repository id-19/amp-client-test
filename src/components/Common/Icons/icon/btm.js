...
const SvgBtm = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon": "Btm",
      "Action": "Unknown",
      "Context": "Assumed to be a button or feature indicator"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#btm_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#btm_svg__b" />
