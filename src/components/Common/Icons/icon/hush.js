...
const SvgHush = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Click", {"Icon Name": "Hush", "Action": "Click"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#hush_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#hush_svg__b" />
