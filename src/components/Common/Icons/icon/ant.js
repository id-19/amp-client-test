...
const SvgAnt = props => (
  <div onClick={() => mixpanel.track("Icon Click", {"Icon": "Ant", "Action": "Click", "Context": "Used in a clickable context"})}>
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#ant_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#ant_svg__b" />
