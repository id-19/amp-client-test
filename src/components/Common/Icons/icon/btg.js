...
const SvgBtg = props => {
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Type": "btg",
      "Context": props.context || "Unknown" // Assuming 'context' is a prop for where the icon is used
    });
  };

  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick} // Added onClick event handler
    >
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          ...
          <use fill="url(#btg_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#btg_svg__b" />
