...
const SvgPoly = props => {
  // Handler function for tracking the event
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconInteraction} // Adding the onClick event handler
    >
      <defs>
      ...
      <g fill="none">
        ...
        <use fill="url(#poly_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#poly_svg__b" />
