...
const SvgSan = props => (
  <button onClick={() => mixpanel.track("Sign Up Button Click", {"Icon": "San", "Action": "Navigate", "Destination": "Sign Up Page"})}>
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none">
        ...
        <use fill="url(#san_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#san_svg__b" />
