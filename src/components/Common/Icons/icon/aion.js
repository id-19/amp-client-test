  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none">
        ...
        <use fill="url(#aion_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#aion_svg__b" />
        ...
        <g fill="#FFF" filter="url(#aion_svg__d)" transform="translate(5 4)">
          ...
          <path d="M20.35 8.425a9.558 9.558 0 0 0-1.896-3.59l.9-.746a10.71 10.71 0 0 1 2.125 4.025l-1.128.311zM1.86 16.976A10.742 10.742 0 0 1 .067 11.02c0-2.962 1.18-5.728 3.323-7.789l.814.837a9.564 9.564 0 0 0-2.966 6.952c0 1.899.554 3.737 1.6 5.316l-.978.64z" opacity={0.5} />
        </g>
      </g>
    </svg>
  );
