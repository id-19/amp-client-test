...
const SvgOax = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    ...
    <g fill="none">
      ...
      <use fill="url(#oax_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#oax_svg__b" />
...
// New component that wraps the SvgOax in a button for interaction
const SvgOaxButton = (props) => {
  const handleClick = () => {
