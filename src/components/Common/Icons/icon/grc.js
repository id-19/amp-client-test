...
const SvgGrc = props => {
  const handleIconClick = () => {
    mixpanel.track("Icon Click", {
      "Icon Name": "Grc",
      "Context": "User clicked on the Grc icon",
      "Location": "Could be dynamically determined based on where the icon is used"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#grc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#grc_svg__b" />
