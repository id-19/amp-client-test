...
const SvgCrw = props => {
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "CRW Icon",
      "File Path": "src/components/Common/Icons/icon/crw.js"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#crw_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#crw_svg__b" />
