...
const SvgSteem = props => {
  const handleClick = () => {
    // Triggering Mixpanel event tracking
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={props.onClick || handleClick} // Using the onClick prop for tracking
    >
      <defs>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#steem_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#steem_svg__b" />
