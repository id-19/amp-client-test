...
const SvgEmc2 = props => {
  ...
  return (
    <button className="learn-more-emc2" type="button" aria-label="Learn more about EMC2" onClick={handleLearnMoreClick} >
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        ...
        <g fill="none">
          ...
          <use fill="url(#emc2_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#emc2_svg__b" />
          <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
          <g fill="#FFF" filter="url(#emc2_svg__d)" transform="translate(6 8)">
            <path fillOpacity={0.4} d="M1.894 10.161H6.29L4.399 14H0l1.894-3.839zm2.505-5.08h4.398L6.91 8.91h-4.4l1.889-3.83zM6.905.001h4.398l-1.889 3.83H5.018L6.905 0z" />
            <path fillOpacity={0.6} d="M6.277 10.16h4.398L8.78 13.997H4.383l1.894-3.839zm2.506-5.08h4.397l-1.888 3.828H6.894L8.783 5.08zM11.288 0h4.398l-1.889 3.829H9.4L11.288 0z" />
