  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={trackIconClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#etc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#etc_svg__b" />
        <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
        <g fill="#FFF" filter="url(#etc_svg__d)" transform="translate(9 3)">
          <path fillRule="nonzero" d="M6.989 12.553l-6.721-.577 6.72-3.802v4.379zm0 4.46v6.94C4.652 20.315 2.076 16.311 0 13.07c2.45 1.38 5.008 2.823 6.989 3.944zm0-10.068L0 10.845 6.989 0v6.945z" />
          <path fillOpacity={0.601} fillRule="nonzero" d="M13.71 11.976l-6.721.577V8.174l6.72 3.802zm-6.721 5.038c1.98-1.12 4.537-2.564 6.988-3.944-2.076 3.242-4.652 7.246-6.988 10.882v-6.938zm0-10.069V0l6.988 10.845-6.988-3.9z" />
