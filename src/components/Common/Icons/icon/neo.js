...
const SvgNeo = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Clicked", {"Icon Name": "Neo", "Action": "TBD"})}>
    <defs>
      ...
      <path id="neo_svg__e" d="M25 21.58l-6.99-3.258v-7.22L25 8.623V21.58zM14.823 25L8 21.821V8.958l6.823 3.18V25zm10.01-16.843l-.113.04-6.71 2.381-.168.06-2.843 1.008-6.73-3.136 9.573-3.396.084-.03.177-.063.062-.021 6.73 3.136-.063.021z" />
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#neo_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#neo_svg__b" />
