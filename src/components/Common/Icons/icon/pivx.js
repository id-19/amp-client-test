  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleIconClick} >
      <defs>
        ...
        <path id="pivx_svg__e" d="M17.153 10.741v2.255H10v-2.255h7.153zM23 11.831c0 3.208-2.29 5.395-5.528 5.395H13.93V23.5h-2.6v-8.693h5.925c1.935 0 3.095-1.103 3.095-2.976 0-1.837-1.15-2.913-3.07-2.913h-1.687l-4.544.014V6.5h6.41c3.088 0 5.296 1.912 5.522 4.831l.019.5z" />
      ...
      <g fill="none">
        ...
        <use fill="url(#pivx_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#pivx_svg__b" />
