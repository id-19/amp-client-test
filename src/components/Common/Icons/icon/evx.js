...
const SvgEvx = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#evx_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#evx_svg__b" />
...
// Assuming the button component is defined elsewhere and uses SvgEvx
// Here is a conceptual implementation of the button with Mixpanel event tracking
const SubmitButton = () => {
  const handleClick = () => {
  ...
  return (
    <button type="submit" aria-label="Submit Form" className="submit-button" onClick={handleClick} >
      <SvgEvx />
      Submit
    </button>
  );
