...
const SvgSlr = props => {
  const handleClick = () => {
    mixpanel.track("Icon Interaction", {
      "Icon Name": "SvgSlr",
      "Action": "Click",
      "Context": "Specify context here" // Uncomment and specify context as needed
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#slr_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#slr_svg__b" />
