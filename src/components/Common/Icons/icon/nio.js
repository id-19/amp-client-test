...
const SvgNio = props => {
  ...
  return (
    <button type="button" className="sign-up-btn" onClick={trackSignUp} style={{ border: 'none', background: 'none', padding: 0, cursor: 'pointer' }}>
      <svg width={props.width || 64} height={props.height || 64} {...props}>
        <defs>
          ...
          <path id="nio_svg__e" d="M16 12.764h-4.822L16 4.5l4.822 8.264H16zm.655 9.736l2.515-4.309 2.411-4.131L26.5 22.5h-9.845zm-3.825-4.309l2.515 4.309H5.5l4.919-8.44 2.41 4.131z" />
        ...
        <g fill="none">
          ...
          <use fill="url(#nio_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#nio_svg__b" />
