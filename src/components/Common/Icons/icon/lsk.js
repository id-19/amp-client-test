...
const SvgLsk = props => {
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={props.onClick || handleClick}>
      <defs>
      ...
      <g fill="none">
        ...
        <use fill="url(#lsk_svg__c)" fillRule="evenodd" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#lsk_svg__b" />
