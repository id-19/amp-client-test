  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#pink_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#pink_svg__b" />
        <circle cx={16} cy={15} r={14.5} stroke="#000" strokeOpacity={0.097} />
        <g fill="#FFF" filter="url(#pink_svg__d)" transform="translate(6.5 5)">
          <path d="M16.952 2.929l-1.87 1.883A7.238 7.238 0 0 0 9.93 2.663c-3.915 0-7.11 3.11-7.278 7.01h-.008v7.122A10.003 10.003 0 0 1 0 10C0 4.477 4.446 0 9.93 0a9.865 9.865 0 0 1 7.022 2.929zm0 14.142A9.865 9.865 0 0 1 10.092 20v-2.664a7.238 7.238 0 0 0 4.99-2.147l1.87 1.883z" opacity={0.5} />
