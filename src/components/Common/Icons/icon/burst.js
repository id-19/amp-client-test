...
const SvgBurst = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Interaction", { "Icon Name": "Burst", "Action": "Click", "Context": "Share Button" })}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#burst_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#burst_svg__b" />
