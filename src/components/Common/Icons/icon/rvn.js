...
const SvgRvn = props => {
  // Event Handler for tracking the click event
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleSvgClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#rvn_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#rvn_svg__b" />
