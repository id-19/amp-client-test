...
const SvgGno = props => (
  <svg width={props.width || 64} height={props.height || 64} {...props} onClick={() => mixpanel.track("Icon Click", {"Icon": "Gno", "Action": "Unknown"})}>
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#gno_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#gno_svg__b" />
