...
const SvgSc = props => (
  <svg 
    ...
    {...props} 
    onClick={() => mixpanel.track("Icon Interaction", { "Context": "Sign Up Button", "Icon": "SvgSc", "Action": "Click" })}
  >
    <defs>
      ...
      <path id="sc_svg__e" d="M16 6.5a8.5 8.5 0 0 1 8.5 8.5v8.5H16a8.5 8.5 0 1 1 0-17zm5.1 13.6v-5.023c0-2.82-2.255-5.163-5.074-5.177a5.106 5.106 0 0 0-5.126 5.126c.014 2.819 2.358 5.074 5.177 5.074H21.1z" />
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <use fill="url(#sc_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#sc_svg__b" />
