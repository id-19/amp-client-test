...
const SvgBch = props => {
  const handleClick = () => {
    mixpanel.track("Icon Click", {
      "Icon": "BCH",
      "Action": "Click",
      "Context": "Assuming it's used as a clickable icon"
    });
  };
  ...
  return (
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <use fill="url(#bch_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#bch_svg__b" />
