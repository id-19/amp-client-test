...
const SvgMoac = props => {
  useEffect(() => {
    mixpanel.track("Icon Rendered", {
      "Icon Name": "Moac",
      "Render Context": "Unknown - Determine based on usage"
    });
  }, []);
  ...
  const handleClick = () => {
    mixpanel.track("Icon Clicked", {
      "Icon Name": "Moac",
      "Click Context": "Unknown - Determine based on usage"
    });
  };
    ...
    <svg width={props.width || 64} height={props.height || 64} {...props} onClick={handleClick}>
      ...
      <g fill="none">
        <g transform="translate(1)">
          ...
          <use fill="url(#moac_svg__c)" style={{ mixBlendMode: 'soft-light', }} xlinkHref="#moac_svg__b" />
          <circle strokeOpacity={0.097} stroke="#000" strokeLinejoin="square" cx={15} cy={15} r={14.5} />
        </g>
        <path d="M15.792 14.792L9.423 8.423l-.138-.208L7.02 6v17.515h2.284V11.4l4.916 4.985 1.592 1.592 1.592-1.592L22.32 11.4v12.115h2.284V6L22.32 8.215z" fill="#FFF" />
      </g>
    </svg>
  );
};
